function test() {
	...
	for (q = 0; q <= 4; q++) {
		if (q == 0 && b[0] != undefined && b[0].innerHTML == a) {
			console.log("This was just run 1");
			document.getElementById("ansi").value = b[1].innerHTML;
			document.getElementById("diameter").value = b[2].innerHTML;
			document.getElementById("manufacturer").value = b[3].innerHTML;
			document.getElementById("valve_model").value = b[4].innerHTML;
			document.getElementById("valve_serial").value = b[5].innerHTML;
			document.getElementById("op_pressure").value = b[6].innerHTML;
			document.getElementById("temp_rating").value = b[7].innerHTML;
			document.getElementById("wind_speed").value = b[8].innerHTML;
			document.getElementById("act_model").value = b[9].innerHTML;
			document.getElementById("pipe_maop").value = b[10].innerHTML;
			document.getElementById("pipe_design").value = b[11].innerHTML;
			document.getElementById("pipe_grade").value = b[12].innerHTML;
			document.getElementById("tubing").value = b[13].innerHTML;
		}
		else if (q == 1 && c[0] != undefined && c[0].innerHTML == a) {
			console.log("This was just run 2");
			document.getElementById("ansi").value = c[1].innerHTML;
			document.getElementById("diameter").value = c[2].innerHTML;
			document.getElementById("manufacturer").value = c[3].innerHTML;
			document.getElementById("valve_model").value = c[4].innerHTML;
			document.getElementById("valve_serial").value = c[5].innerHTML;
			document.getElementById("op_pressure").value = c[6].innerHTML;
			document.getElementById("temp_rating").value = c[7].innerHTML;
			document.getElementById("wind_speed").value = c[8].innerHTML;
			document.getElementById("act_model").value = c[9].innerHTML;
			document.getElementById("pipe_maop").value = c[10].innerHTML;
			document.getElementById("pipe_design").value = c[11].innerHTML;
			document.getElementById("pipe_grade").value = c[12].innerHTML;
			document.getElementById("tubing").value = c[13].innerHTML;
		} 
		else if (q == 2 && d[0] != undefined && d[0].innerHTML == a) {
			console.log("This was just run ");
			document.getElementById("ansi").value = d[1].innerHTML;
			document.getElementById("diameter").value = d[2].innerHTML;
			document.getElementById("manufacturer").value = d[3].innerHTML;
			document.getElementById("valve_model").value = d[4].innerHTML;
			document.getElementById("valve_serial").value = d[5].innerHTML;
			document.getElementById("op_pressure").value = d[6].innerHTML;
			document.getElementById("temp_rating").value = d[7].innerHTML;
			document.getElementById("wind_speed").value = d[8].innerHTML;
			document.getElementById("act_model").value = d[9].innerHTML;
			document.getElementById("pipe_maop").value = d[10].innerHTML;
			document.getElementById("pipe_design").value = d[11].innerHTML;
			document.getElementById("pipe_grade").value = d[12].innerHTML;
			document.getElementById("tubing").value = d[13].innerHTML;
		} 
...
function check_act() {
	...
	if (add_form2 != null && actuators_dropdown == null && pressure_dropdown == null) {
		...
		form_entry.setAttribute("style", "display: none;");
		...
		new_div.setAttribute("style", "textAlign: center;");
		new_div.setAttribute("id", "sub_button_div");
		document.getElementById("form_to_submit").appendChild(new_div);
		var sub_button = document.createElement("button");
		sub_button.innerHTML = "Submit";
		sub_button.setAttribute("id", "sub_button");
		//document.querySelector("FORM").appendChild(sub_button);
		document.getElementById("sub_button_div").appendChild(sub_button);
